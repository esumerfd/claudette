...
- 🎤 Voice input system
- 🔊 Audio output
- 🔋 Battery powered (2-3 hour runtime)

**Cost**: ~$155-175 | **Build Time**: 6-8 weeks

## What You'll Build

- **Display**: 1.3" OLED in left eye for HUD
- **Audio**: USB mic + 3W speaker
- **Power**: 6×AA batteries (recommended) or 4×9V
- **Features**: Voice recognition, animated display, portable
...
✅ **6×AA Batteries** (Recommended)
- Runtime: 2-3 hours
- Cost: $16
- Best value

⚠️ **4×9V Batteries** (Compact)
- Runtime: 30-60 min
- Cost: $19
